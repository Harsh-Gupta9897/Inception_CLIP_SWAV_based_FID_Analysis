...
from StableDiffusionScratch.utils import get_features
...
if __name__=='__main__':
    ...
    fid_models = ["CLIP", "SWAV", "InceptionV3"]
    ...
    for fid_model in fid_models:
        ...
        for dataset in datasets:
            for augment_type in augment_types:
                ...
                time_df.to_csv('experiments/execution_time_cutmix.csv', index_label='Evaluation Metric')
                fid_df.to_csv('experiments/fid_value_cutmix.csv', index_label='Evaluation Metric')
